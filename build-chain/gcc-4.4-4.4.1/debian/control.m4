...
',`dnl native
Build-Depends: dpkg-dev (>= 1.14.15), debhelper (>= 5.0.62), gcc-multilib [amd64 mips mipsel powerpc ppc64 s390 sparc kfreebsd-amd64], LIBC_BUILD_DEP, LIBC_BIARCH_BUILD_DEP AUTO_BUILD_DEP AUTOGEN_BUILD_DEP libunwind7-dev (>= 0.98.5-6) [ia64], libatomic-ops-dev [ia64], zlib1g-dev, gawk, lzma, xz-utils, patchutils, BINUTILS_BUILD_DEP, binutils-hppa64 (>= BINUTILSV) [hppa], gperf (>= 3.0.1), bison (>= 1:2.3), flex, gettext, texinfo (>= 4.3), libmpfr-dev (>= 2.3.0), FORTRAN_BUILD_DEP locales [locale_no_archs], procps, sharutils, PASCAL_BUILD_DEP JAVA_BUILD_DEP GNAT_BUILD_DEP SPU_BUILD_DEP CLOOG_BUILD_DEP MPC_BUILD_DEP ELF_BUILD_DEP CHECK_BUILD_DEP realpath (>= 1.9.12), chrpath, lsb-release, make (>= 3.81), quilt
...
Section: debug
Priority: extra
Depends: BASEDEP, libgcc1 (= ${gcc:EpochVersion}), ${misc:Depends}
...
Section: debug
Priority: extra
Depends: BASEDEP, libgcc2 (= ${gcc:Version}), ${misc:Depends}
Description: GCC support library (debug symbols)`'ifdef(`TARGET)',` (TARGET)', `')
 Debug symbols for the GCC support library.
ifdef(`TARGET', `dnl
 .
...
Section: debug
Priority: extra
Depends: BASEDEP, libgcc4 (= ${gcc:Version}), ${misc:Depends}
Description: GCC support library (debug symbols)`'ifdef(`TARGET)',` (TARGET)', `')
 Debug symbols for the GCC support library.
ifdef(`TARGET', `dnl
 .
...
Section: debug
Priority: extra
Depends: BASEDEP, lib64gcc1 (= ${gcc:EpochVersion}), ${misc:Depends}
Description: GCC support library (debug symbols)`'ifdef(`TARGET)',` (TARGET)', `')
 Debug symbols for the GCC support library.
ifdef(`TARGET', `dnl
 .
...
Section: debug
Priority: extra
Depends: BASEDEP, lib32gcc1 (= ${gcc:EpochVersion}), ${misc:Depends}
Description: GCC support library (debug symbols)`'ifdef(`TARGET)',` (TARGET)', `')
 Debug symbols for the GCC support library.
ifdef(`TARGET', `dnl
 .
...
Section: libs
Priority: extra
Depends: BASEDEP, libc6-neon, ${shlibs:Depends}, ${misc:Depends}
...
Section: debug
Priority: extra
Depends: BASEDEP, libn32gcc1 (= ${gcc:EpochVersion}), ${misc:Depends}
Description: GCC support library (debug symbols)`'ifdef(`TARGET)',` (TARGET)', `')
 Debug symbols for the GCC support library.
ifdef(`TARGET', `dnl
 .
...
Section: debug
Priority: extra
Depends: BASEDEP, libmudflap`'MF_SO (= ${gcc:Version}), ${misc:Depends}
...
Section: libdevel
Priority: PRI(optional)
Depends: BASEDEP, libmudflap`'MF_SO (>= ${gcc:Version}), ${dep:libcdev}, ${shlibs:Depends}, ${misc:Depends}
...
Section: debug
Priority: extra
Depends: BASEDEP, libgomp`'GOMP_SO (= ${gcc:Version}), ${misc:Depends}
...
Section: devel
Priority: ifdef(`TARGET',`extra',`PRI(optional)')
Depends: BASEDEP, gfortran`'PV`'TS (= ${gcc:Version}), gcc`'PV-multilib`'TS (= ${gcc:Version}), ${dep:libfortranbiarch}, ${shlibs:Depends}, ${misc:Depends}
...
Architecture: any
Priority: extra
Depends: BASEDEP, libgfortran`'FORTRAN_SO (= ${gcc:Version}), ${misc:Depends}
...
Architecture: biarchn32_archs
Priority: extra
Depends: BASEDEP, libn32gfortran`'FORTRAN_SO (= ${gcc:Version}), ${misc:Depends}
...
Conflicts: gnat (<< 4.1), gnat-3.1, gnat-3.2, gnat-3.3, gnat-3.4, gnat-3.5, gnat-4.0, gnat-4.1, gnat-4.2, gnat-4.3
