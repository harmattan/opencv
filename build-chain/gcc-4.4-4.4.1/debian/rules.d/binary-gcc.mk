...
ifeq ($(with_ssp),yes)
	mv $(d)/$(PF)/lib/libssp_nonshared.a $(d)/$(gcc_lib_dir)/
endif
ifeq ($(with_libssp),yes)
...
ifeq ($(with_ssp),yes)
  ifeq ($(biarch64),yes)
	mv $(d)/$(PF)/$(lib64)/libssp_nonshared.a $(d_gcc_m)/$(gcc_lib_dir)/$(biarch64subdir)/
  endif
  ifeq ($(biarch32),yes)
	mv $(d)/$(lib32)/libssp_nonshared.a $(d_gcc_m)/$(gcc_lib_dir)/$(biarch32subdir)/
  endif
  ifeq ($(biarchn32),yes)
	mv $(d)/$(PF)/$(libn32)/libssp_nonshared.a $(d_gcc_m)/$(gcc_lib_dir)/$(biarchn32subdir)/
  endif
endif
